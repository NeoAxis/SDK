namespace ChatExample
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.buttonServer = new EditorBase.Theme.EditorButton();
			this.buttonClient = new EditorBase.Theme.EditorButton();
			this.SuspendLayout();
			// 
			// buttonCancel
			// 
		...
		private EditorBase.Theme.EditorButton buttonServer;
		private EditorBase.Theme.EditorButton buttonClient;
	}
}
