...
#ifdef HAVE_ANDROID
extern void SetJNIEnvironmentAndJavaVM(void* pEnv, void* pJavaVM);
ALC_API ALCvoid ALC_APIENTRY alcSetJNIEnvironmentAndJavaVM(void* pEnv, void* pJavaVM)
{
	SetJNIEnvironmentAndJavaVM(pEnv, pJavaVM);
}
#endif
