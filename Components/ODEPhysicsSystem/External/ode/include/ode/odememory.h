...
//betauser
typedef void * dAllocFunction (uint32 size);
typedef void * dReallocFunction (void *ptr, uint32 oldsize, uint32 newsize);
typedef void dFreeFunction (void *ptr, uint32 size);
...
//betauser
ODE_API void * dAlloc (uint32 size);
ODE_API void * dRealloc (void *ptr, uint32 oldsize, uint32 newsize);
ODE_API void dFree (void *ptr, uint32 size);
