namespace ExportTo3DModelMEAddon
{
	partial class AddonForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.checkBoxExportSelectedObjectsOnly = new EditorBase.Theme.EditorCheckBox();
			this.textBoxOutputFileName = new EditorBase.Theme.EditorTextBox();
			this.label3 = new System.Windows.Forms.Label();
			this.buttonExport = new EditorBase.Theme.EditorButton();
			this.buttonSelectOutputFileName = new EditorBase.Theme.EditorButton();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			this.textBoxOutputFileName.PromptText = "";
			...
			this.textBoxOutputFileName.WordWrap = false;
			// 
			// label3
			// 
			...
			// 
			this.buttonSelectOutputFileName.Location = new System.Drawing.Point(449, 108);
			...
			this.buttonSelectOutputFileName.Size = new System.Drawing.Size(40, 22);
		...
		private EditorBase.Theme.EditorCheckBox checkBoxExportSelectedObjectsOnly;
		private EditorBase.Theme.EditorTextBox textBoxOutputFileName;
		private System.Windows.Forms.Label label3;
		private EditorBase.Theme.EditorButton buttonExport;
		private EditorBase.Theme.EditorButton buttonSelectOutputFileName;
