...
{
	class PhysXUniversalJoint : UniversalJoint, IPhysXJoint
	{
		IntPtr nativeJoint;
		UniversalAxis axis1;
		UniversalAxis axis2;
		...
		public class UniversalAxis : RotationAxis
		{
			public PhysXUniversalJoint joint;
			int index;
			...
			{
				Log.Warning( "PhysXUniversalJoint: Axis: The method \"GetAngle()\" is not supported." );
		...
		public PhysXUniversalJoint( Body body1, Body body2 )
