...
#ifndef PS_LINUX_INLINE_AOS_H
#define PS_LINUX_INLINE_AOS_H
...
PX_FORCE_INLINE bool hasZeroElementinFloatV(const FloatV a)
{
	...
	return (_mm_comieq_ss(_mm_shuffle_ps(a, a, _MM_SHUFFLE(0,0,0,0)),FloatV_From_F32(0.0f)) ? true : false);
}
...
PX_FORCE_INLINE bool hasZeroElementInVec3V(const Vec3V a)
{
	...
	return
	(
	 _mm_comieq_ss(_mm_shuffle_ps(a, a, _MM_SHUFFLE(0,0,0,0)),FloatV_From_F32(0.0f)) ||
...
PX_FORCE_INLINE void F32Array_Aligned_From_Vec4V(Vec4V a, PxF32* f)
{
	VECMATHAOS_ASSERT(0 == ((PxU64)f & 0x0f));
	_mm_store_ps(f,a);
}
...
{
	VECMATHAOS_ASSERT(isValidVec3V(a));
	return V3Max(a,V3Neg(a));//sw/physx/shared/reviewed/3/feature/sdk/include/windows/PsWindowsInlineAoS.h
}   
...
PX_FORCE_INLINE Mat34V M34InverseV(const Mat34V& a)
{
	Mat34V aInv;
	const BoolV tfft=BTFFT();
	const BoolV tttf=BTTTF();
