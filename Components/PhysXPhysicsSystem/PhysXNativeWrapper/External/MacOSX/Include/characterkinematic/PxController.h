...
public:
	...
	*/
	...
	However there are a few situations that cannot be automatically detected, and those require manual
	invalidation of the cache. This is mainly the case when the filtering parameters change (the
	PxControllerFilters parameter of the PxController::move call).
